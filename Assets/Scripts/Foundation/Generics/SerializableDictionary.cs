...
namespace Arctic.Foundation.Generics
{
    [System.Serializable]
    public sealed class SerializableDictionary<TKey, TValue>
    {
        ...
        public static implicit operator Dictionary<TKey, TValue> (SerializableDictionary<TKey, TValue> serializedDict) 
        {
        ...
        {
            SerializableDictionary<TKey, TValue> converted = new SerializableDictionary<TKey, TValue>();
        ...
        public static implicit operator SerializableDictionary<TKey, TValue>(List<SerializedKeyValuePair> serializedKeyValues) 
        {
            SerializableDictionary<TKey, TValue> converted = new SerializableDictionary<TKey, TValue>();
